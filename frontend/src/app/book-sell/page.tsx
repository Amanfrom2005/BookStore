...
const page = () => {
  ...
  const onSubmit = async (data: BookDetails) => {
    try {
      ...
      toast.error('faild to list the book, please try again later');
      console.log(error);
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-10 text-center">
          <h1 className="text-4xl mb-4 font-bold text-blue-600">Sell your used Books</h1>
          <p className="text-xl text-gray-600 mb-4">Submit a free classified add to sell your used books for cash in India</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-8'>
          ...
          <div className='shadow-lg border-t-4 border-t-blue-500 rounded-lg pb-4'>
            ...
            <CardContent className='space-y-6 pt-6'>
                  ...
                  render={({field}) => (
                    <RadioGroup onValueChange={field.onChange} value={field.value} className='flex space-x-4'>
                        {filters.condition.map((con) => (
                          <div className='flex items-center space-x-2' key={con}>
              ...
              <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                ...
                />
                {errors.classType && (<p className="text-red-500 text-sm">{errors.classType.message}</p>)}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="border-2 border-dashed border-blue-300 rounded-lg p-4 bg-blue-50">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <Input onChange={handleImageUpload} id='images' type='file' multiple accept='images/*' className='hidden'/>
                  </div>
                    ...
                    <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                      {uploadedImages.map((image, index) => (
                        <div className="relative" key={index}>
                          ...
                          />
                          <Button onClick={() => removeImage(index)} size='icon' variant='destructive' className='absolute -top-2 -right-2'>
                            <X className='h-4 w-4'/>
                          </Button>
                        </div>
                      ))}
          ...
          <div className='shadow-lg border-t-4 border-t-green-500 rounded-lg pb-4'>
            <CardHeader className='bg-gradient-to-r from-green-50 to-emerald-50 py-4'>
              ...
              <CardDescription>(Description, MRP, auther, etc...)</CardDescription>
            </CardHeader>
                  ...
                  <AccordionContent>
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                        ...
                        <Input {...register("price", {required: "price is Required",})} placeholder="enter your price" type="text" className="md:w-3/4"/>
                        {errors.price && (<p className="text-red-500 text-sm">{errors.price.message}</p>)}
                      </div>

                      <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                        <Label htmlFor='author' className='md:w-1/4 font-medium text-gray-700'>Author</Label>
                        <Input {...register("author")} placeholder="enter author name" type="text" className="md:w-3/4"/>
                      </div>

                      <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                        <Label htmlFor='edition' className='md:w-1/4 font-medium text-gray-700'>Edition (Year)</Label>
                        <Input {...register("edition")} placeholder="enter book edition year" type="text" className="md:w-3/4"/>
                      </div>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                  ...
                  <AccordionContent>
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                        ...
                        <Textarea id='description' {...register("description")} placeholder="enter your description" className="md:w-3/4" rows={6}/>
                      </div>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <Controller
                        ...
                        render={({field}) => (
                          <Checkbox id='freeShipping' checked={field.value === 'free'} onCheckedChange={(checked) => {field.onChange(checked ? 'free' : '');}} />
                        )}
                      />
                      <Label htmlFor='freeShipping' className='font-medium text-gray-700'>
                        Free Shipping
                      </Label>
                    </div>
                  </div>
                  <p className="text-muted-foreground text-sm">Buyers Prefer free shippig or low shipping charges.</p>
                </div>
              </div>
            </CardContent>
          </div>
           ...
           <div className='shadow-lg border-t-4 border-t-blue-500 rounded-lg pb-4'>
            ...
            <CardContent className='space-y-6 pt-6'>
              <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                ...
                <p className="text-sm text-muted-foreground mb-2">After your book is sold, in what mode would you like to recive the payment</p>
                <Controller
                  name='paymentMode'
                  control={control}
              ...
              {paymentMode === 'UPI' && (
                <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                  <Label htmlFor='upiId' className='md:w-1/4 font-medium text-gray-700'> UPI ID/NUMBER </Label>
                    <Input 
                    {...register("paymentDetails.upiId", 
                      {required: "UPI ID is Required", 
                      pattern:{value:/[a-zA-Z0-9.\-_]{2,256}@[a-zA-Z]{2,64}/,
                      message:'Invalid UPI ID format'
                      }
                    })} 
                    placeholder="enter your UPI ID" 
                    type="text"/>
                    {errors.paymentDetails?.upiId && (<p className="text-red-500 text-sm">{errors.paymentDetails.upiId.message}</p>)}
                </div>
              )}
                ...
                <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                  <Label htmlFor='accountNumber' className='md:w-1/4 font-medium text-gray-700'> Account Number </Label>
                    ...
                    {...register("paymentDetails.bankDetails.accountNumber", 
                      ...
                      pattern:{value:/^[0-9]{9,18}$/,
                      message:'Invalid Account Number format'
                      }
                    })} 
                    placeholder="enter your Account Number" 
                    type="text"/>
                    {errors.paymentDetails?.bankDetails?.accountNumber && (<p className="text-red-500 text-sm">{errors.paymentDetails.bankDetails.accountNumber.message}</p>)}
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                  <Label htmlFor='ifscCode' className='md:w-1/4 font-medium text-gray-700'> IFSC Code </Label>
                    ...
                    {...register("paymentDetails.bankDetails.ifscCode", 
                      ...
                      pattern:{value:/^[A-Z]{4}[0][A-Z0-9]{6}$/,
                      message:'Invalid IFSC Code format'
                      }
                    })} 
                    placeholder="enter your IFSC Code" 
                    type="text"/>
                    {errors.paymentDetails?.bankDetails?.ifscCode && (<p className="text-red-500 text-sm">{errors.paymentDetails.bankDetails.ifscCode.message}</p>)}
                </div>

                <div className="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                  <Label htmlFor='bankName' className='md:w-1/4 font-medium text-gray-700'> Bank Name </Label>
                    <Input 
                    {...register("paymentDetails.bankDetails.bankName", {required: "Bank Name is Required"})} 
                    placeholder="enter your Bank Name" 
                    type="text"/>
                    {errors.paymentDetails?.bankDetails?.bankName && (<p className="text-red-500 text-sm">{errors.paymentDetails.bankDetails.bankName.message}</p>)}
                </div>
                </>
              )}

...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative h-[600px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-white text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-8">
            Buy Books online and Sell in India
          </h1>
          <div className="flex flex-col sm:flex-row gap-6">
            <Link href="/books">
              <Button
                size="lg"
                className="group cursor-pointer bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-6 rounded-xl"
              >
            ...
            <Link href="/book-sell">
              <Button
                size="lg"
                className="group cursor-pointer bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-600 hover:to-yellow-500 text-black px-8 py-6 rounded-xl"
              >
                <div className="flex items-center gap-3">
      ...
      <Link href="/books" className="w-[208px]  mt-10 mb-10 block rounded-xl">
        <Button
          size="lg"
          className="flex mx-auto bg-yellow-500 px-8 py-6 cursor-pointer"
        >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className="rounded-xl border border-neutral-200 bg-white text-neutral-950 shadow dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 h-full flex flex-col overflow-hidden transition-all duration-300 hover:shadow-lg"
              >

import { Clock, Facebook, HeadphoneOffIcon, Instagram, Shield, Twitter, Youtube } from "lucide-react";
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">POLYCIES</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/terms-of-use"
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex items-center gap-4 rounded-xl p-6 shadow-sm">
                ...
                <div className="">
                  ...
                  <p className="text-sm text-gray-500">100% secure online transection</p>
                </div>
              </div>
              <div className="flex items-center gap-4 rounded-xl p-6 shadow-sm">
                <div className="rounded-full p-3">
              ...
              <div className="flex items-center gap-4 rounded-xl p-6 shadow-sm">
                <div className="rounded-full p-3">
                  <HeadphoneOffIcon className="w-6 h-6"/>
                </div>
                <div className="">
                  <h3 className="font-semibold">Coustomer Support</h3>
                  <p className="text-sm text-gray-500">friendly coustomer support</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row gap-4 md:gap-0 justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Image src='/icons/visa.svg' alt="visa" height={30} width={50} className="filter brightness-100 invert" />
            <Image src='/icons/rupay.svg' alt="rupay" height={30} width={50} className="filter brightness-100 invert" />

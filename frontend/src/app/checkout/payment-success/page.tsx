        ...
        <Card className='shadow-2xl bg-white bg-opacity-90 backdrop:blur-sm'>
          <CardHeader className='text-center border-b border-gray-200 pb-6'>
            ...
            <CardDescription className='text-gray-600 mt-2'>
              Thankyou for your purchase. Your order has been conformed
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className='pt-6'>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-gray-600">Order Details</h3>
              ...
              <div className="space-y-4">
                ...
                <ul className='space-y-3'>
                  ...
                  >
                    ...
                    <span className='text-sm' >You will recive an email confirmation shortly.</span>
                  </motion.li>
                  <motion.li
                    initial={{x: -50, opacity: 0}}
                    animate={{x: 0, opacity: 1}}
                  ...
                  >
                    ...
                    <span className='text-sm' >You can track ypur order status in your account.</span>
                  </motion.li>
                </ul>
              </div>
            </div>
